...
def search_vulnerabilities(query):
    # Use the raw query (service name, version, etc.) for best results
    search_term = query.strip()
    encoded_term = quote(search_term)
    api_url = f"https://services.nvd.nist.gov/rest/json/cves/2.0?keywordSearch={encoded_term}&resultsPerPage=50"
